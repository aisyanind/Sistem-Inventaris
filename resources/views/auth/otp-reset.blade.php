...
<body class="bg-[#e2e2e2] flex items-center justify-center min-h-screen">

    <div class="bg-white shadow-lg rounded-lg w-full max-w-md p-8 border border-gray-300">
        <h2 class="text-2xl font-bold text-center text-[#981318] mb-6">Verifikasi OTP Reset Password</h2>
        ...
        {{-- Form OTP --}}
        <form method="POST" action="{{ route('otp.reset.verify') }}" class="space-y-5">
            @csrf
            <div>
